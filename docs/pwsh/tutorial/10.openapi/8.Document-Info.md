...
4. Add contact and license information via `Add-KrOpenApiContact` and `Add-KrOpenApiLicense`.
...
- **Contact & License**: Standard OpenAPI metadata for ownership and usage terms. For licenses, you can use either `-Url` or the OpenAPI 3.1/3.2 `-Identifier` (SPDX).
