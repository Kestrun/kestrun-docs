...
Use `-ExternalValue` to point to a URL containing the literal example payload.
This is handy when the example is large or maintained outside the OpenAPI document.
...
Previous: [WebHooks](./12.WebHooks)
Next: [Swagger Petstore](./14.Petstore-API)
