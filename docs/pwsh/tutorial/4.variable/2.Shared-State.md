...
Previous: [Shared Variables][Previous]
Next: [Shared State Snapshots][Next]
...
[Next]: ./3.Shared-State-Snapshots
[Introduction]: ../1.introduction/index#prerequisites
[SharedStateGuide]: /guides/sharedstate

## See also

For deeper architectural details (implicit vs explicit, atomic patterns, runspace lifecycle, and snapshot export/import) see the
[Shared State & Runspaces Guide][SharedStateGuide], Tutorial 4.1 for implicit variable sharing, and Tutorial 4.3 for snapshot round-trips.
