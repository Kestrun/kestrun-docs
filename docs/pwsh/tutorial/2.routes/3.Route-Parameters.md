...
File: [`docs/pwsh/tutorial/examples/2.3-Route-Parameters.ps1`][2.3-Route-Parameters.ps1]

```powershell
{% include_relative /docs/pwsh/tutorial/examples/2.3-Route-Parameters.ps1 %}
```
...
[2.3-Route-Parameters.ps1]: /docs/pwsh/tutorial/examples/2.3-Route-Parameters.ps1
