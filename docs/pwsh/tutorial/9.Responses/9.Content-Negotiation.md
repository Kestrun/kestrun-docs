...
5. `/negotiate`: Uses Write-KrResponse with object, format determined by Accept header.
6. `/explicit`: Uses Write-KrResponse with explicit ContentType override.
7. `/error`: Uses Write-KrResponse with error object and 404 status code.
...
- [Content Negotiation in ASP.NET Core](https://docs.microsoft.com/en-us/aspnet/core/web-api/advanced/formatting)
