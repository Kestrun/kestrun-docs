...
File: [`examples/PowerShell/Tutorial/3.1-Static-Routes.ps1`][3.1-Static-Routes.ps1]
...
[3.1-Static-Routes.ps1]: https://github.com/Kestrun/Kestrun/blob/main/examples/PowerShell/Tutorial/3.1-Static-Routes.ps1
