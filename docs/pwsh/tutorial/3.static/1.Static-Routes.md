...
File: [`examples/PowerShell/Tutorial/6-Static-Routes.ps1`][6-Static-Routes.ps1]
...
# Add a static files service (with unknown file types enabled for demo purposes)
...
```powershell
. .\examples\PowerShell\Tutorial\6-Static-Routes.ps1
```
...
Next: [File Server & Directory Browsing](./2.File-Server.md)  
...
[6-Static-Routes.ps1]: https://github.com/Kestrun/Kestrun/blob/main/examples/PowerShell/Tutorial/6-Static-Routes.ps1
