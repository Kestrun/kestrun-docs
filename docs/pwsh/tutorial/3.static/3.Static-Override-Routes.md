...
File: [`examples/PowerShell/Tutorial/3.3-Static-OverrideRoutes.ps1`][3.3-Static-OverrideRoutes.ps1]
...
[3.3-Static-OverrideRoutes.ps1]: https://github.com/Kestrun/Kestrun/blob/main/examples/PowerShell/Tutorial/3.3-Static-OverrideRoutes.ps1
