...
File: [`pwsh/tutorial/examples/22.3-Url-Encoded.ps1`][22.3-Url-Encoded.ps1]

```powershell
{% include examples/pwsh/22.3-Url-Encoded.ps1 %}
```
...
[22.3-Url-Encoded.ps1]: /pwsh/tutorial/examples/22.3-Url-Encoded.ps1
