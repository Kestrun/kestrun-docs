...
```powershell
Add-KrOpenApiInfo [[-Server] <KestrunHost>] [[-DocId] <string[]>] [-Title] <string>
 [-Version] <string> [[-Summary] <string>] [[-Description] <string>] [[-TermsOfService] <uri>]
 [<CommonParameters>]
```
...
An array of OpenAPI document IDs to which the Info will be added.
Default is 'default'.
