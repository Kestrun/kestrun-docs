...
Convenience wrapper around the C# extension AddOpenIdConnectAuthentication.
...
```yaml
Type: System.String
DefaultValue: OpenID Connect Authentication
SupportsWildcards: false
Aliases: []
ParameterSets:
- Name: (All)
...
```yaml
Type: Kestrun.Authentication.OidcOptions
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.IdentityModel.Protocols.OpenIdConnect.OpenIdConnectResponseType
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
