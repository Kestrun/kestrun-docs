...
Razor pages (or a generic [`PwshKestrunModel`](../PwshKestrunModel.md)) can then read that dynamic object.
...
| pool | Kestrun’s shared [`KestrunRunspacePoolManager`](../../Kestrun.Scripting/KestrunRunspacePoolManager.md). |
...
* class [PowerShellRazorPage](../PowerShellRazorPage.md)
