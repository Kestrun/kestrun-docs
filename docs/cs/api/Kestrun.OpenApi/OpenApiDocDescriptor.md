...
| [AutoErrorResponseContentTypes](OpenApiDocDescriptor/AutoErrorResponseContentTypes) { get; set; } | Gets or sets the content types used for autogenerated OpenAPI client-error responses. |
| [AutoErrorResponseSchemaId](OpenApiDocDescriptor/AutoErrorResponseSchemaId) { get; set; } | Gets or sets the schema identifier used for autogenerated OpenAPI client-error responses. |
...
| const [DefaultAutoErrorResponseContentType](OpenApiDocDescriptor/DefaultAutoErrorResponseContentType) | Default content type used for autogenerated OpenAPI client-error responses. |
| const [DefaultAutoErrorResponseSchemaId](OpenApiDocDescriptor/DefaultAutoErrorResponseSchemaId) | Default schema identifier used for autogenerated OpenAPI client-error responses. |
