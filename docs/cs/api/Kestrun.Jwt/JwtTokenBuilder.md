...
| [EncryptWithJwkJson](JwtTokenBuilder/EncryptWithJwkJson)(…) | Encrypts the JWT payload using a JWK (public key) in JSON format. |
| [EncryptWithJwkPath](JwtTokenBuilder/EncryptWithJwkPath)(…) | Encrypts the JWT payload using a JWK read from a file. |
...
| [SignWithJwkJson](JwtTokenBuilder/SignWithJwkJson)(…) | Signs the JWT using a JWK JSON string (RSA / EC / oct). |
...
* [JwtTokenBuilder.cs](https://github.com/Kestrun/Kestrun/tree/main/src/CSharp/Kestrun/Jwt/JwtTokenBuilder.cs)
