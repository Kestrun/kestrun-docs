...
Tags a RouteHandlerBuilder with a [`ScriptLanguageAttribute`](../ScriptLanguageAttribute) for the specified language.
...
* class [RouteHandlerBuilderLanguageExtensions](../RouteHandlerBuilderLanguageExtensions)
