...
Configures the application pipeline to use a specific language runtime for endpoints tagged with the given [`ScriptLanguage`](../ScriptLanguage.md).
...
* class [LanguageRuntimeExtensions](../LanguageRuntimeExtensions.md)
