...
| [OpenApiClassesPath](KestrunRunspacePoolManager/OpenApiClassesPath) { get; set; } | Path to the OpenAPI class definitions to be injected into each runspace. |
...
* [KestrunRunspacePoolManager.cs](https://github.com/Kestrun/Kestrun/tree/main/src/CSharp/Kestrun/Scripting/KestrunRunspacePoolManager.cs)
