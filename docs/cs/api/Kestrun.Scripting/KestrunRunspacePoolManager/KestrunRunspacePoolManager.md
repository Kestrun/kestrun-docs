...
Initializes a new instance of the [`KestrunRunspacePoolManager`](../KestrunRunspacePoolManager.md) class with the specified minimum and maximum runspaces, initial session state, and thread options.
