...
| [AllowAnonymous](MapRouteOptions/AllowAnonymous) { get; } | If true, allows anonymous access to this route. |
...
| [DisableAntiforgery](MapRouteOptions/DisableAntiforgery) { get; } | If true, disables antiforgery protection for this route. |
...
| [RateLimitPolicyName](MapRouteOptions/RateLimitPolicyName) { get; } | The name of the rate limit policy to apply to this route, if any. |
...
| [ShortCircuit](MapRouteOptions/ShortCircuit) { get; } | If true, short-circuits the pipeline after this route. |
| [ShortCircuitStatusCode](MapRouteOptions/ShortCircuitStatusCode) { get; } | Status code to return if short-circuiting the pipeline after this route. |
