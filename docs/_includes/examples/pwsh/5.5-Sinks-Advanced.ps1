...
# $base = $base | Add-KrSinkEventLog -Source 'KestrunSample' -LogName 'Application'

# Syslog example (choose one)
# $base = $base | Add-KrSinkSyslogUdp -Hostname '127.0.0.1' -Port 514 -AppName 'KestrunSample'
# $base = $base | Add-KrSinkSyslogTcp -Hostname '127.0.0.1' -Port 1468 -AppName 'KestrunSample'
...
Add-KrMapRoute -Verbs Get -Path "/log" -ScriptBlock {
    Write-KrLog -Logger $logger -Level Information -Message "Advanced sinks example" -Properties @{ Demo = 'true' }
